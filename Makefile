...
eb-create:
	@eb create ${ENV_NAME} --region=us-east-1 --cname="${ENV_NAME}" --elb-type application \
	  --envvars QUARKUS_QPID_JMS_URL=${QUARKUS_QPID_JMS_URL},QUARKUS_QPID_JMS_USERNAME=${QUARKUS_QPID_JMS_USERNAME},QUARKUS_HIBERNATE_SEARCH_ORM_ELASTICSEARCH_HOSTS=${QUARKUS_HIBERNATE_SEARCH_ORM_ELASTICSEARCH_HOSTS},QUARKUS_DATASOURCE_USERNAME=${QUARKUS_DATASOURCE_USERNAME},BULK_DATA_LOADS_S3SECRETKEY=${BULK_DATA_LOADS_S3SECRETKEY},BULK_DATA_LOADS_S3ACCESSKEY=${BULK_DATA_LOADS_S3ACCESSKEY},QUARKUS_DATASOURCE_JDBC_URL=${QUARKUS_DATASOURCE_JDBC_URL},QUARKUS_QPID_JMS_PASSWORD=${QUARKUS_QPID_JMS_PASSWORD},BULK_DATA_LOADS_S3PATHPREFIX=${BULK_DATA_LOADS_S3PATHPREFIX},QUARKUS_DATASOURCE_PASSWORD=${QUARKUS_DATASOURCE_PASSWORD},QUARKUS_HIBERNATE_SEARCH_ORM_ELASTICSEARCH_PROTOCOL=${QUARKUS_HIBERNATE_SEARCH_ORM_ELASTICSEARCH_PROTOCOL}
