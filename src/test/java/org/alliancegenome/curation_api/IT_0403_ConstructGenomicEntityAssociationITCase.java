...
public class IT_0403_ConstructGenomicEntityAssociationITCase extends BaseITCase {
	...
	private void loadRequiredEntities() {
		...
		note = createNote(noteType, "CGEA Test Note", false, false, reference);
		note2 = createNote(noteType2, "CGEA Test Note 2", false, false, reference2);
	}
