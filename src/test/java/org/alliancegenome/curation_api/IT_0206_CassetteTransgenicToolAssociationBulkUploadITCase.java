...
/**
 * SCRUM-6535: bulk load coverage for Cassette Transgenic Tool Associations.
...
@DisplayName("206 - Cassette Transgenic Tool Associations bulk upload")
@Order(206)
@SuppressWarnings("checkstyle:TypeNameCheck")
public class IT_0206_CassetteTransgenicToolAssociationBulkUploadITCase extends BaseITCase {

	private String subjectId = "WB:Cassette0001";
	private String relationName = "expresses";
	private String objectId = "WB:TransgenicTool0001";
	private String reference = "AGRKB:000000001";
	private String noteType = "test_cassette_association_note";
	private Cassette cassette;
	private TransgenicTool transgenicTool;
	...
	private final String bulkPostEndpoint = "/api/cassettetransgenictoolassociation/bulk/WB/associationFile";
	private final String findByEndpoint = "/api/cassettetransgenictoolassociation/findBy";
	private final String testFilePath = "src/test/resources/bulk/CA04_cassette_transgenic_tool_association/";

	private void loadRequiredEntities() throws Exception {
		cassette = getCassette(subjectId);
		transgenicTool = getTransgenicTool(objectId);
	}
	...
	public void associationBulkUploadCheckFields() throws Exception {
		...
		RestAssured.given().
			when().
			get(findByEndpoint + "?cassetteId=" + cassette.getId() + "&relationName=" + relationName + "&transgenicToolId=" + transgenicTool.getId()).
			then().
			statusCode(200).
			body("entity.relation.name", is(relationName)).
			body("entity.cassetteAssociationSubject.primaryExternalId", is(subjectId)).
			body("entity.cassetteTransgenicToolAssociationObject.primaryExternalId", is(objectId)).
