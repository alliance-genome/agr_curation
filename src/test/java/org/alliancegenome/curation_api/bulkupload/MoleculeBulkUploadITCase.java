...
public class MoleculeBulkUploadITCase {
    ...
    public void moleculeBulkUploadCheckModExamples() throws Exception {
        ...
        RestAssured.given().
            ...
            body(content).
            when().
            post("/api/molecule/bulk/moleculefile?async=false").
            then().
            statusCode(200);
    ...
    public void moleculeBulkUploadCheckFields() throws Exception {
        ...
        RestAssured.given().
                ...
                body("results[6].crossReferences[0].id", is("TEST:TestMol00000001")).
                body("results[6].crossReferences[0].pages[0]", is("molecule"));
    }
    ...
    public void moleculeBulkUploadNoInchi() throws Exception {
        ...
        RestAssured.given().
                ...
                body("results[7].crossReferences[0].id", is("TEST:TestMol00000004")).
                body("results[7].crossReferences[0].pages[0]", is("molecule"));
    }
    ...
    public void moleculeBulkUploadNoInchiKey() throws Exception {
        ...
        RestAssured.given().
                ...
                body("results[8].crossReferences[0].id", is("TEST:TestMol00000005")).
                body("results[8].crossReferences[0].pages[0]", is("molecule"));
    }
    ...
    public void moleculeBulkUploadNoIupac() throws Exception {
        ...
        RestAssured.given().
                ...
                body("results[9].crossReferences[0].id", is("TEST:TestMol00000006")).
                body("results[9].crossReferences[0].pages[0]", is("molecule"));
    }
    ...
    public void moleculeBulkUploadNoFormula() throws Exception {
        ...
        RestAssured.given().
                ...
                body("results[10].crossReferences[0].id", is("TEST:TestMol00000007")).
                body("results[10].crossReferences[0].pages[0]", is("molecule"));
    }
    ...
    public void moleculeBulkUploadNoSmiles() throws Exception {
        ...
        RestAssured.given().
                ...
                body("results[11].crossReferences[0].id", is("TEST:TestMol00000008")).
                body("results[11].crossReferences[0].pages[0]", is("molecule"));
    }
    ...
    public void moleculeBulkUploadNoSynonyms() throws Exception {
        ...
        RestAssured.given().
                ...
                body("results[12].crossReferences[0].id", is("TEST:TestMol00000009")).
                body("results[12].crossReferences[0].pages[0]", is("molecule"));
    }
