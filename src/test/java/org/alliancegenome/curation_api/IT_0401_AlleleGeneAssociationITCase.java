...
public class IT_0401_AlleleGeneAssociationITCase extends BaseITCase {
	...
	private void loadRequiredEntities() {
		...
		note = createNote(noteType, "AGA Test Note", false, false, reference);
		note2 = createNote(noteType2, "AGA Test Note 2", false, false, reference2);
	}
