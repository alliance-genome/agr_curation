...
@Order(402)
public class Test_0402_AlleleConstructAssociationITCase extends BaseITCase {
	...
	private void loadRequiredEntities() {
		...
		note = createNote(noteType, "ACA Test Note", false, false, reference);
		note2 = createNote(noteType2, "ACA Test Note 2", false, false, reference2);
	}
