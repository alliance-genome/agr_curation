...
public class IT_0304_DiseaseAnnotationITCase extends BaseITCase {
	...
	private void loadRequiredEntities() throws Exception {
		...
		relatedNote = createNote(noteType, "Test text", false, false, null);
		duplicateNote = createNote(noteType, "Test text", false, false, null);
