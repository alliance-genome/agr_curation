...
public class IT_0307_ConstructITCase extends BaseITCase {
	...
	private void loadRequiredEntities() {
		...
		relatedNote = createNote(noteType, "Test text", false, false, reference);
		relatedNote2 = createNote(noteType2, "Test text 2", false, false, reference2);
