...
public class AlleleITCase {
	...
	public void createValidAllele() {
		allele = createAllele(ALLELE_CURIE, ALLELE_TAXON, ALLELE_SYMBOL);
	...
	public void createMissingCurieAllele() {
		Allele noCurieAllele = createAllele(null, ALLELE_TAXON, ALLELE_SYMBOL);
	...
	public void createMissingSymbolAllele() {
		Allele noSymbolAllele = createAllele(ALLELE_CURIE, ALLELE_TAXON, null);
	...
	public void createMissingTaxonAllele() {
		Allele noTaxonAllele = createAllele(ALLELE_CURIE, null, ALLELE_SYMBOL);
	...
	public void createInvalidTaxonAllele() {
		Allele invalidTaxonAllele = createAllele(ALLELE_CURIE, INVALID_TAXON, ALLELE_SYMBOL);
	...
	private Allele createAllele(String curie, String taxon, String symbol) {
