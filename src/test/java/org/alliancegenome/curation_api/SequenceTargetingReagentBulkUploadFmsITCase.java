...
public class SequenceTargetingReagentBulkUploadFmsITCase extends BaseITCase {
	...
	public void sqtrBulkUploadMissingRequiredFields() throws Exception {
		...
		checkFailedBulkLoad(sqtrBulkPostEndpoint, sqtrTestFilePath + "MR_01_no_name.json", "Records", 2, 1, 1);
		checkFailedBulkLoad(sqtrBulkPostEndpoint, sqtrTestFilePath + "MR_02_no_taxon.json", "Records", 2, 1, 1);
	}
	...
	public void sqtrBulkUploadEmptyRequiredFields() throws Exception {
		...
		checkFailedBulkLoad(sqtrBulkPostEndpoint, sqtrTestFilePath + "ER_01_empty_name.json", "Records", 2, 1, 1);

		checkFailedBulkLoad(sqtrBulkPostEndpoint, sqtrTestFilePath + "ER_02_empty_taxon.json", "Records", 2, 1, 1);
