...
ALTER TABLE ONLY public.geneexpressionexperiment_crossreference
    ADD CONSTRAINT fkjhiyltsfwpstp20je8ruckv7k FOREIGN KEY (geneexpressionexperiment_id) REFERENCES public.geneexpressionexperiment(id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE ONLY public.geneexpressionexperiment_crossreference
    ADD CONSTRAINT fkpebq3g4092pi4q4licvigwhp6 FOREIGN KEY (crossreferences_id) REFERENCES public.crossreference(id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION;
