...
CREATE INDEX sequencetargetingreagent_secondaryIdentifiers_sequencetargetingreagent_index ON sequencetargetingreagent_secondaryidentifiers USING btree (sequencetargetingreagent_id);
CREATE INDEX sequencetargetingreagent_synonyms_sequencetargetingreagent_index ON sequencetargetingreagent_synonyms USING btree (sequencetargetingreagent_id);
