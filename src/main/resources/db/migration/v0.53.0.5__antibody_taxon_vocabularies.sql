-- SCRUM-6496: Accommodate new antibody host/antigen taxon vocabularies.
-- Replaces Antibody.taxon/antigenTaxon (NCBITaxonTerm) with hostTaxonTerm/antigenTaxonTerm
...
-- Three host taxon curies in use (NCBITaxon:10114 Rattus, NCBITaxon:10140 Cavia, NCBITaxon:9923
-- Capra aegagrus) have no exact match in the new non-redundant list; map them to the nearest
...
-- match a vocabulary term above leaves the new *taxonterm_id column NULL, and the DROP
-- COLUMNs below are irreversible once run. Roll back the whole migration if that happened
-- instead of quietly dropping the original value.
DO $$
