...
UPDATE affectedgenomicmodel_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM affectedgenomicmodel_aud WHERE id IS NULL;
UPDATE affectedgenomicmodel_aud t SET subtype_id = a.id FROM auditedobject a WHERE t.subtype_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE agmdiseaseannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM agmdiseaseannotation_aud WHERE id < 200250000;
UPDATE agmdiseaseannotation_aud t SET inferredallele_id = a.id FROM auditedobject a WHERE t.inferredallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE agmdiseaseannotation_aud t SET assertedallele_id = a.id FROM auditedobject a WHERE t.assertedallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE agmdiseaseannotation_aud t SET inferredgene_id = a.id FROM auditedobject a WHERE t.inferredgene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE agmdiseaseannotation_aud t SET subject_id = a.id FROM auditedobject a WHERE t.subject_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE agmdiseaseannotation_gene_aud t SET agmdiseaseannotation_id = a.id FROM auditedobject a WHERE t.agmdiseaseannotation_id = a.old_id AND a.tablename = 'association';
UPDATE agmdiseaseannotation_gene_aud t SET assertedgenes_id = a.id FROM auditedobject a WHERE t.assertedgenes_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allele_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM allele_aud WHERE id IS NULL;
UPDATE allele_aud t SET incollection_id = a.id FROM auditedobject a WHERE t.incollection_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE allele_note_aud t SET allele_id = a.id FROM auditedobject a WHERE t.allele_curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM allele_note_aud WHERE allele_id IS NULL;
UPDATE allele_note_aud t SET relatednotes_id = a.id FROM auditedobject a WHERE t.relatednotes_id = a.old_id AND a.tablename = 'note';
UPDATE allele_reference_aud t SET allele_id = a.id FROM auditedobject a WHERE t.allele_curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM allele_reference_aud WHERE allele_id IS NULL;
UPDATE allele_reference_aud t SET references_id = a.id FROM auditedobject a WHERE t.references_curie = a.old_curie AND a.tablename = 'informationcontententity';
UPDATE alleledatabasestatusslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM alleledatabasestatusslotannotation_aud WHERE id < 200250000;
UPDATE alleledatabasestatusslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE alleledatabasestatusslotannotation_aud t SET databasestatus_id = a.id FROM auditedobject a WHERE t.databasestatus_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE allelediseaseannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM allelediseaseannotation_aud WHERE id < 200250000;
UPDATE allelediseaseannotation_aud t SET inferredgene_id = a.id FROM auditedobject a WHERE t.inferredgene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelediseaseannotation_aud t SET subject_id = a.id FROM auditedobject a WHERE t.subject_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelediseaseannotation_gene_aud t SET allelediseaseannotation_id = a.id FROM auditedobject a WHERE t.allelediseaseannotation_id = a.old_id AND a.tablename = 'association';
UPDATE allelediseaseannotation_gene_aud t SET assertedgenes_id = a.id FROM auditedobject a WHERE t.assertedgenes_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelefullnameslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM allelefullnameslotannotation_aud WHERE id < 200250000;
UPDATE allelefullnameslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelefunctionalimpactslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM allelefunctionalimpactslotannotation_aud WHERE id < 200250000;
UPDATE allelefunctionalimpactslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelefunctionalimpactslotannotation_aud t SET phenotypeterm_id = a.id FROM auditedobject a WHERE t.phenotypeterm_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE allelefunctionalimpactslotannotation_vocabularyterm_aud t SET allelefunctionalimpactslotannotation_id = a.id FROM auditedobject a WHERE t.allelefunctionalimpactslotannotation_id = a.old_id AND a.tablename = 'slotannotation';
UPDATE allelefunctionalimpactslotannotation_vocabularyterm_aud t SET functionalimpacts_id = a.id FROM auditedobject a WHERE t.functionalimpacts_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE allelegeneassociation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM allelegeneassociation_aud WHERE id < 200250000;
UPDATE allelegeneassociation_aud t SET subject_id = a.id FROM auditedobject a WHERE t.subject_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelegeneassociation_aud t SET object_id = a.id FROM auditedobject a WHERE t.object_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelegenomicentityassociation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM allelegenomicentityassociation_aud WHERE id < 200250000;
UPDATE allelegenomicentityassociation_aud t SET evidencecode_id = a.id FROM auditedobject a WHERE t.evidencecode_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE allelegenomicentityassociation_aud t SET relatednote_id = a.id FROM auditedobject a WHERE t.relatednote_id = a.old_id AND a.tablename = 'note';
UPDATE allelegenomicentityassociation_aud t SET relation_id = a.id FROM auditedobject a WHERE t.relation_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE allelegermlinetransmissionstatusslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM allelegermlinetransmissionstatusslotannotation_aud WHERE id < 200250000;
UPDATE allelegermlinetransmissionstatusslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelegermlinetransmissionstatusslotannotation_aud t SET germlinetransmissionstatus_id = a.id FROM auditedobject a WHERE t.germlinetransmissionstatus_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE alleleinheritancemodeslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM alleleinheritancemodeslotannotation_aud WHERE id < 200250000;
UPDATE alleleinheritancemodeslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE alleleinheritancemodeslotannotation_aud t SET inheritancemode_id = a.id FROM auditedobject a WHERE t.inheritancemode_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE alleleinheritancemodeslotannotation_aud t SET phenotypeterm_id = a.id FROM auditedobject a WHERE t.phenotypeterm_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE allelemutationtypeslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM allelemutationtypeslotannotation_aud WHERE id < 200250000;
UPDATE allelemutationtypeslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelemutationtypeslotannotation_soterm_aud t SET allelemutationtypeslotannotation_id = a.id FROM auditedobject a WHERE t.allelemutationtypeslotannotation_id = a.old_id AND a.tablename = 'slotannotation';
UPDATE allelemutationtypeslotannotation_soterm_aud t SET mutationtypes_id = a.id FROM auditedobject a WHERE t.mutationtypes_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE allelenomenclatureeventslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM allelenomenclatureeventslotannotation_aud WHERE id < 200250000;
UPDATE allelenomenclatureeventslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelenomenclatureeventslotannotation_aud t SET nomenclatureevent_id = a.id FROM auditedobject a WHERE t.nomenclatureevent_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE allelesecondaryidslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM allelesecondaryidslotannotation_aud WHERE id < 200250000;
UPDATE allelesecondaryidslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelesymbolslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM allelesymbolslotannotation_aud WHERE id < 200250000;
UPDATE allelesymbolslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE allelesynonymslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM allelesynonymslotannotation_aud WHERE id < 200250000;
UPDATE allelesynonymslotannotation_aud t SET singleallele_id = a.id FROM auditedobject a WHERE t.singleallele_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE alliancemember_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'organization';
DELETE FROM alliancemember_aud WHERE id < 200250000;
UPDATE anatomicalterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM anatomicalterm_aud WHERE id IS NULL;
UPDATE annotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM annotation_aud WHERE id < 200250000;
UPDATE annotation_aud t SET dataprovider_id = a.id FROM auditedobject a WHERE t.dataprovider_id = a.old_id AND a.tablename = 'dataprovider';
UPDATE annotation_conditionrelation_aud t SET annotation_id = a.id FROM auditedobject a WHERE t.annotation_id = a.old_id AND a.tablename = 'association';
UPDATE annotation_conditionrelation_aud t SET conditionrelations_id = a.id FROM auditedobject a WHERE t.conditionrelations_id = a.old_id AND a.tablename = 'conditionrelation';
UPDATE annotation_note_aud t SET annotation_id = a.id FROM auditedobject a WHERE t.annotation_id = a.old_id AND a.tablename = 'association';
UPDATE annotation_note_aud t SET relatednotes_id = a.id FROM auditedobject a WHERE t.relatednotes_id = a.old_id AND a.tablename = 'note';
UPDATE apoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM apoterm_aud WHERE id IS NULL;
UPDATE association_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM association_aud WHERE id < 200250000;
UPDATE atpterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM atpterm_aud WHERE id IS NULL;
UPDATE biologicalentity_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM biologicalentity_aud WHERE id IS NULL;
UPDATE biologicalentity_aud t SET taxon_id = a.id FROM auditedobject a WHERE t.taxon_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE biologicalentity_aud t SET dataprovider_id = a.id FROM auditedobject a WHERE t.dataprovider_id = a.old_id AND a.tablename = 'dataprovider';
UPDATE bspoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM bspoterm_aud WHERE id IS NULL;
UPDATE bulkfmsload_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkload';
DELETE FROM bulkfmsload_aud WHERE id < 200250000;
UPDATE bulkload_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkload';
DELETE FROM bulkload_aud WHERE id < 200250000;
UPDATE bulkload_aud t SET group_id = a.id FROM auditedobject a WHERE t.group_id = a.old_id AND a.tablename = 'bulkloadgroup';
UPDATE bulkloadfile_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkloadfile';
DELETE FROM bulkloadfile_aud WHERE id < 200250000;
UPDATE bulkloadfile_aud t SET bulkload_id = a.id FROM auditedobject a WHERE t.bulkload_id = a.old_id AND a.tablename = 'bulkload';
UPDATE bulkloadfileexception_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkloadfileexception';
DELETE FROM bulkloadfileexception_aud WHERE id < 200250000;
UPDATE bulkloadfileexception_aud t SET bulkloadfilehistory_id = a.id FROM auditedobject a WHERE t.bulkloadfilehistory_id = a.old_id AND a.tablename = 'bulkloadfilehistory';
UPDATE bulkloadfilehistory_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkloadfilehistory';
DELETE FROM bulkloadfilehistory_aud WHERE id < 200250000;
UPDATE bulkloadfilehistory_aud t SET bulkloadfile_id = a.id FROM auditedobject a WHERE t.bulkloadfile_id = a.old_id AND a.tablename = 'bulkloadfile';
UPDATE bulkloadgroup_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkloadgroup';
DELETE FROM bulkloadgroup_aud WHERE id < 200250000;
UPDATE bulkmanualload_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkload';
DELETE FROM bulkmanualload_aud WHERE id < 200250000;
UPDATE bulkscheduledload_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkload';
DELETE FROM bulkscheduledload_aud WHERE id < 200250000;
UPDATE bulkurlload_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'bulkload';
DELETE FROM bulkurlload_aud WHERE id < 200250000;
UPDATE chebiterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM chebiterm_aud WHERE id IS NULL;
UPDATE chemicalterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM chemicalterm_aud WHERE id IS NULL;
UPDATE clterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM clterm_aud WHERE id IS NULL;
UPDATE cmoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM cmoterm_aud WHERE id IS NULL;
UPDATE conditionrelation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'conditionrelation';
DELETE FROM conditionrelation_aud WHERE id < 200250000;
UPDATE conditionrelation_aud t SET conditionrelationtype_id = a.id FROM auditedobject a WHERE t.conditionrelationtype_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE conditionrelation_aud t SET singlereference_id = a.id FROM auditedobject a WHERE t.singlereference_curie = a.old_curie AND a.tablename = 'informationcontententity';
UPDATE conditionrelation_experimentalcondition_aud t SET conditionrelation_id = a.id FROM auditedobject a WHERE t.conditionrelation_id = a.old_id AND a.tablename = 'conditionrelation';
UPDATE conditionrelation_experimentalcondition_aud t SET conditions_id = a.id FROM auditedobject a WHERE t.conditions_id = a.old_id AND a.tablename = 'experimentalcondition';
UPDATE construct_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'reagent';
DELETE FROM construct_aud WHERE id < 200250000;
UPDATE construct_reference_aud t SET construct_id = a.id FROM auditedobject a WHERE t.construct_id = a.old_id AND a.tablename = 'reagent';
UPDATE construct_reference_aud t SET references_id = a.id FROM auditedobject a WHERE t.references_curie = a.old_curie AND a.tablename = 'informationcontententity';
UPDATE constructcomponentslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM constructcomponentslotannotation_aud WHERE id < 200250000;
UPDATE constructcomponentslotannotation_aud t SET singleconstruct_id = a.id FROM auditedobject a WHERE t.singleconstruct_id = a.old_id AND a.tablename = 'reagent';
UPDATE constructcomponentslotannotation_aud t SET taxon_id = a.id FROM auditedobject a WHERE t.taxon_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE constructcomponentslotannotation_aud t SET relation_id = a.id FROM auditedobject a WHERE t.relation_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE constructcomponentslotannotation_note_aud t SET constructcomponentslotannotation_id = a.id FROM auditedobject a WHERE t.constructcomponentslotannotation_id = a.old_id AND a.tablename = 'slotannotation';
UPDATE constructcomponentslotannotation_note_aud t SET relatednotes_id = a.id FROM auditedobject a WHERE t.relatednotes_id = a.old_id AND a.tablename = 'note';
UPDATE constructfullnameslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM constructfullnameslotannotation_aud WHERE id < 200250000;
UPDATE constructfullnameslotannotation_aud t SET singleconstruct_id = a.id FROM auditedobject a WHERE t.singleconstruct_id = a.old_id AND a.tablename = 'reagent';
UPDATE constructgenomicentityassociation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM constructgenomicentityassociation_aud WHERE id < 200250000;
UPDATE constructgenomicentityassociation_aud t SET subject_id = a.id FROM auditedobject a WHERE t.subject_id = a.old_id AND a.tablename = 'reagent';
UPDATE constructgenomicentityassociation_aud t SET object_id = a.id FROM auditedobject a WHERE t.object_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE constructgenomicentityassociation_aud t SET relation_id = a.id FROM auditedobject a WHERE t.relation_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE constructgenomicentityassociation_note_aud t SET constructgenomicentityassociation_id = a.id FROM auditedobject a WHERE t.constructgenomicentityassociation_id = a.old_id AND a.tablename = 'association';
UPDATE constructgenomicentityassociation_note_aud t SET relatednotes_id = a.id FROM auditedobject a WHERE t.relatednotes_id = a.old_id AND a.tablename = 'note';
UPDATE constructsymbolslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM constructsymbolslotannotation_aud WHERE id < 200250000;
UPDATE constructsymbolslotannotation_aud t SET singleconstruct_id = a.id FROM auditedobject a WHERE t.singleconstruct_id = a.old_id AND a.tablename = 'reagent';
UPDATE constructsynonymslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM constructsynonymslotannotation_aud WHERE id < 200250000;
UPDATE constructsynonymslotannotation_aud t SET singleconstruct_id = a.id FROM auditedobject a WHERE t.singleconstruct_id = a.old_id AND a.tablename = 'reagent';
UPDATE crossreference_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'crossreference';
DELETE FROM crossreference_aud WHERE id < 200250000;
UPDATE crossreference_aud t SET resourcedescriptorpage_id = a.id FROM auditedobject a WHERE t.resourcedescriptorpage_id = a.old_id AND a.tablename = 'resourcedescriptorpage';
UPDATE daoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM daoterm_aud WHERE id IS NULL;
UPDATE dataprovider_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'dataprovider';
DELETE FROM dataprovider_aud WHERE id < 200250000;
UPDATE dataprovider_aud t SET sourceorganization_id = a.id FROM auditedobject a WHERE t.sourceorganization_id = a.old_id AND a.tablename = 'organization';
UPDATE dataprovider_aud t SET crossreference_id = a.id FROM auditedobject a WHERE t.crossreference_id = a.old_id AND a.tablename = 'crossreference';
UPDATE diseaseannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM diseaseannotation_aud WHERE id < 200250000;
UPDATE diseaseannotation_aud t SET object_id = a.id FROM auditedobject a WHERE t.object_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE diseaseannotation_aud t SET relation_id = a.id FROM auditedobject a WHERE t.relation_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE diseaseannotation_aud t SET diseasegeneticmodifierrelation_id = a.id FROM auditedobject a WHERE t.diseasegeneticmodifierrelation_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE diseaseannotation_aud t SET annotationtype_id = a.id FROM auditedobject a WHERE t.annotationtype_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE diseaseannotation_aud t SET geneticsex_id = a.id FROM auditedobject a WHERE t.geneticsex_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE diseaseannotation_aud t SET secondarydataprovider_id = a.id FROM auditedobject a WHERE t.secondarydataprovider_id = a.old_id AND a.tablename = 'dataprovider';
UPDATE diseaseannotation_biologicalentity_aud t SET diseaseannotation_id = a.id FROM auditedobject a WHERE t.diseaseannotation_id = a.old_id AND a.tablename = 'association';
UPDATE diseaseannotation_biologicalentity_aud t SET diseasegeneticmodifiers_id = a.id FROM auditedobject a WHERE t.diseasegeneticmodifiers_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE diseaseannotation_ecoterm_aud t SET diseaseannotation_id = a.id FROM auditedobject a WHERE t.diseaseannotation_id = a.old_id AND a.tablename = 'association';
UPDATE diseaseannotation_ecoterm_aud t SET evidencecodes_id = a.id FROM auditedobject a WHERE t.evidencecodes_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE diseaseannotation_gene_aud t SET diseaseannotation_id = a.id FROM auditedobject a WHERE t.diseaseannotation_id = a.old_id AND a.tablename = 'association';
UPDATE diseaseannotation_gene_aud t SET with_id = a.id FROM auditedobject a WHERE t.with_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE diseaseannotation_vocabularyterm_aud t SET diseaseannotation_id = a.id FROM auditedobject a WHERE t.diseaseannotation_id = a.old_id AND a.tablename = 'association';
UPDATE diseaseannotation_vocabularyterm_aud t SET diseasequalifiers_id = a.id FROM auditedobject a WHERE t.diseasequalifiers_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE doterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM doterm_aud WHERE id IS NULL;
UPDATE dpoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM dpoterm_aud WHERE id IS NULL;
UPDATE ecoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ecoterm_aud WHERE id IS NULL;
UPDATE emapaterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM emapaterm_aud WHERE id IS NULL;
UPDATE evidenceassociation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM evidenceassociation_aud WHERE id < 200250000;
UPDATE evidenceassociation_informationcontententity_aud t SET evidenceassociation_id = a.id FROM auditedobject a WHERE t.evidenceassociation_id = a.old_id AND a.tablename = 'association';
UPDATE evidenceassociation_informationcontententity_aud t SET evidence_id = a.id FROM auditedobject a WHERE t.evidence_curie = a.old_curie AND a.tablename = 'informationcontententity';
UPDATE experimentalcondition_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'experimentalcondition';
DELETE FROM experimentalcondition_aud WHERE id < 200250000;
UPDATE experimentalcondition_aud t SET conditionanatomy_id = a.id FROM auditedobject a WHERE t.conditionanatomy_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE experimentalcondition_aud t SET conditionchemical_id = a.id FROM auditedobject a WHERE t.conditionchemical_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE experimentalcondition_aud t SET conditionclass_id = a.id FROM auditedobject a WHERE t.conditionclass_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE experimentalcondition_aud t SET conditiongeneontology_id = a.id FROM auditedobject a WHERE t.conditiongeneontology_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE experimentalcondition_aud t SET conditionid_id = a.id FROM auditedobject a WHERE t.conditionid_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE experimentalcondition_aud t SET conditiontaxon_id = a.id FROM auditedobject a WHERE t.conditiontaxon_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE experimentalconditionontologyterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM experimentalconditionontologyterm_aud WHERE id IS NULL;
UPDATE fbdvterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM fbdvterm_aud WHERE id IS NULL;
UPDATE gene_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM gene_aud WHERE id IS NULL;
UPDATE gene_aud t SET genetype_id = a.id FROM auditedobject a WHERE t.genetype_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE genediseaseannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM genediseaseannotation_aud WHERE id < 200250000;
UPDATE genediseaseannotation_aud t SET sgdstrainbackground_id = a.id FROM auditedobject a WHERE t.sgdstrainbackground_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genediseaseannotation_aud t SET subject_id = a.id FROM auditedobject a WHERE t.subject_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genefullnameslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM genefullnameslotannotation_aud WHERE id < 200250000;
UPDATE genefullnameslotannotation_aud t SET singlegene_id = a.id FROM auditedobject a WHERE t.singlegene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genesecondaryidslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM genesecondaryidslotannotation_aud WHERE id < 200250000;
UPDATE genesecondaryidslotannotation_aud t SET singlegene_id = a.id FROM auditedobject a WHERE t.singlegene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genesymbolslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM genesymbolslotannotation_aud WHERE id < 200250000;
UPDATE genesymbolslotannotation_aud t SET singlegene_id = a.id FROM auditedobject a WHERE t.singlegene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genesynonymslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
UPDATE genesynonymslotannotation_aud t SET singlegene_id = a.id FROM auditedobject a WHERE t.singlegene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genesystematicnameslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM genesystematicnameslotannotation_aud WHERE id < 200250000;
UPDATE genesystematicnameslotannotation_aud t SET singlegene_id = a.id FROM auditedobject a WHERE t.singlegene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genetogeneorthology_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'genetogeneorthology';
DELETE FROM genetogeneorthology_aud WHERE id < 200250000;
UPDATE genetogeneorthology_aud t SET subjectgene_id = a.id FROM auditedobject a WHERE t.subjectgene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genetogeneorthology_aud t SET objectgene_id = a.id FROM auditedobject a WHERE t.objectgene_curie = a.old_curie AND a.tablename = 'biologicalentity';
UPDATE genetogeneorthologycurated_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'genetogeneorthology';
DELETE FROM genetogeneorthologycurated_aud WHERE id < 200250000;
UPDATE genetogeneorthologycurated_aud t SET singlereference_id = a.id FROM auditedobject a WHERE t.singlereference_curie = a.old_curie AND a.tablename = 'informationcontententity';
UPDATE genetogeneorthologycurated_aud t SET evidencecode_id = a.id FROM auditedobject a WHERE t.evidencecode_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE genetogeneorthologygenerated_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'genetogeneorthology';
DELETE FROM genetogeneorthologygenerated_aud WHERE id < 200250000;
UPDATE genetogeneorthologygenerated_aud t SET isbestscore_id = a.id FROM auditedobject a WHERE t.isbestscore_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE genetogeneorthologygenerated_aud t SET isbestscorereverse_id = a.id FROM auditedobject a WHERE t.isbestscorereverse_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE genetogeneorthologygenerated_aud t SET confidence_id = a.id FROM auditedobject a WHERE t.confidence_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE genetogeneorthologygenerated_predictionmethodsmatched_aud t SET genetogeneorthologygenerated_id = a.id FROM auditedobject a WHERE t.genetogeneorthologygenerated_id = a.old_id AND a.tablename = 'genetogeneorthology';
UPDATE genetogeneorthologygenerated_predictionmethodsmatched_aud t SET predictionmethodsmatched_id = a.id FROM auditedobject a WHERE t.predictionmethodsmatched_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE genetogeneorthologygenerated_predictionmethodsnotcalled_aud t SET genetogeneorthologygenerated_id = a.id FROM auditedobject a WHERE t.genetogeneorthologygenerated_id = a.old_id AND a.tablename = 'genetogeneorthology';
UPDATE genetogeneorthologygenerated_predictionmethodsnotcalled_aud t SET predictionmethodsnotcalled_id = a.id FROM auditedobject a WHERE t.predictionmethodsnotcalled_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE genetogeneorthologygenerated_predictionmethodsnotmatched_aud t SET genetogeneorthologygenerated_id = a.id FROM auditedobject a WHERE t.genetogeneorthologygenerated_id = a.old_id AND a.tablename = 'genetogeneorthology';
UPDATE genetogeneorthologygenerated_predictionmethodsnotmatched_aud t SET predictionmethodsnotmatched_id = a.id FROM auditedobject a WHERE t.predictionmethodsnotmatched_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE genomicentity_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM genomicentity_aud WHERE id IS NULL;
UPDATE genomicentity_crossreference_aud t SET genomicentity_id = a.id FROM auditedobject a WHERE t.genomicentity_curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM genomicentity_crossreference_aud WHERE genomicentity_id IS NULL;
UPDATE genomicentity_crossreference_aud t SET crossreferences_id = a.id FROM auditedobject a WHERE t.crossreferences_id = a.old_id AND a.tablename = 'crossreference';
UPDATE goterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM goterm_aud WHERE id IS NULL;
UPDATE hpterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM hpterm_aud WHERE id IS NULL;
UPDATE informationcontententity_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'informationcontententity';
DELETE FROM informationcontententity_aud WHERE id IS NULL;
UPDATE materm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM materm_aud WHERE id IS NULL;
UPDATE miterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM miterm_aud WHERE id IS NULL;
UPDATE mmoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM mmoterm_aud WHERE id IS NULL;
UPDATE mmusdvterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM mmusdvterm_aud WHERE id IS NULL;
UPDATE modterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM modterm_aud WHERE id IS NULL;
UPDATE molecule_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM molecule_aud WHERE id IS NULL;
UPDATE mpathterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM mpathterm_aud WHERE id IS NULL;
UPDATE mpterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM mpterm_aud WHERE id IS NULL;
UPDATE nameslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM nameslotannotation_aud WHERE id < 200250000;
UPDATE nameslotannotation_aud t SET nametype_id = a.id FROM auditedobject a WHERE t.nametype_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE nameslotannotation_aud t SET synonymscope_id = a.id FROM auditedobject a WHERE t.synonymscope_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE ncbitaxonterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ncbitaxonterm_aud WHERE id IS NULL;
UPDATE note_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'note';
DELETE FROM note_aud WHERE id < 200250000;
UPDATE note_aud t SET notetype_id = a.id FROM auditedobject a WHERE t.notetype_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE note_reference_aud t SET note_id = a.id FROM auditedobject a WHERE t.note_id = a.old_id AND a.tablename = 'note';
UPDATE note_reference_aud t SET references_id = a.id FROM auditedobject a WHERE t.references_curie = a.old_curie AND a.tablename = 'informationcontententity';
UPDATE obiterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM obiterm_aud WHERE id IS NULL;
UPDATE ontologyterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ontologyterm_aud WHERE id IS NULL;
UPDATE ontologyterm_crossreference_aud t SET ontologyterm_id = a.id FROM auditedobject a WHERE t.ontologyterm_curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ontologyterm_crossreference_aud WHERE ontologyterm_id IS NULL;
UPDATE ontologyterm_crossreference_aud t SET crossreferences_id = a.id FROM auditedobject a WHERE t.crossreferences_id = a.old_id AND a.tablename = 'crossreference';
UPDATE ontologyterm_definitionurls_aud t SET ontologyterm_id = a.id FROM auditedobject a WHERE t.ontologyterm_curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ontologyterm_definitionurls_aud WHERE ontologyterm_id IS NULL;
UPDATE ontologyterm_isa_ancestor_descendant_aud t SET isadescendants_id = a.id FROM auditedobject a WHERE t.isadescendants_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE ontologyterm_isa_ancestor_descendant_aud t SET isaancestors_id = a.id FROM auditedobject a WHERE t.isaancestors_curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ontologyterm_isa_ancestor_descendant_aud WHERE isadescendants_id IS NULL OR isaancestors_id IS NULL;
UPDATE ontologyterm_isa_parent_children_aud t SET isachildren_id = a.id FROM auditedobject a WHERE t.isachildren_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE ontologyterm_isa_parent_children_aud t SET isaparents_id = a.id FROM auditedobject a WHERE t.isaparents_curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ontologyterm_isa_parent_children_aud WHERE isachildren_id IS NULL OR isaparents_id IS NULL;
UPDATE ontologyterm_secondaryidentifiers_aud t SET ontologyterm_id = a.id FROM auditedobject a WHERE t.ontologyterm_curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ontologyterm_secondaryidentifiers_aud WHERE ontologyterm_id IS NULL;
UPDATE ontologyterm_subsets_aud t SET ontologyterm_id = a.id FROM auditedobject a WHERE t.ontologyterm_curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ontologyterm_subsets_aud WHERE ontologyterm_id IS NULL;
UPDATE ontologyterm_synonym_aud t SET ontologyterm_id = a.id FROM auditedobject a WHERE t.ontologyterm_curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM ontologyterm_synonym_aud WHERE ontologyterm_id IS NULL;
UPDATE ontologyterm_synonym_aud t SET synonyms_id = a.id FROM auditedobject a WHERE t.synonyms_id = a.old_id AND a.tablename = 'synonym';
UPDATE organization_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'organization';
DELETE FROM organization_aud WHERE id < 200250000;
UPDATE organization_aud t SET homepageresourcedescriptorpage_id = a.id FROM auditedobject a WHERE t.homepageresourcedescriptorpage_id = a.old_id AND a.tablename = 'resourcedescriptorpage';
UPDATE patoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM patoterm_aud WHERE id IS NULL;
UPDATE person_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'person';
DELETE FROM person_aud WHERE id < 200250000;
UPDATE person_aud t SET alliancemember_id = a.id FROM auditedobject a WHERE t.alliancemember_id = a.old_id AND a.tablename = 'organization';
UPDATE person_emails_aud t SET person_id = a.id FROM auditedobject a WHERE t.person_id = a.old_id AND a.tablename = 'person';
UPDATE person_oldemails_aud t SET person_id = a.id FROM auditedobject a WHERE t.person_id = a.old_id AND a.tablename = 'person';
UPDATE personsetting_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'personsetting';
DELETE FROM personsetting_aud WHERE id < 200250000;
UPDATE phenotypeterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE pwterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM pwterm_aud WHERE id IS NULL;
UPDATE reagent_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'reagent';
DELETE FROM reagent_aud WHERE id < 200250000;
UPDATE reagent_aud t SET dataprovider_id = a.id FROM auditedobject a WHERE t.dataprovider_id = a.old_id AND a.tablename = 'dataprovider';
UPDATE reagent_secondaryidentifiers_aud t SET reagent_id = a.id FROM auditedobject a WHERE t.reagent_id = a.old_id AND a.tablename = 'reagent';
UPDATE reference_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'informationcontententity';
DELETE FROM reference_aud WHERE id IS NULL;
UPDATE reference_crossreference_aud t SET reference_id = a.id FROM auditedobject a WHERE t.reference_curie = a.old_curie AND a.tablename = 'informationcontententity';
DELETE FROM reference_crossreference_aud WHERE reference_id IS NULL;
UPDATE reference_crossreference_aud t SET crossreferences_id = a.id FROM auditedobject a WHERE t.crossreferences_id = a.old_id AND a.tablename = 'crossreference';
UPDATE resourcedescriptor_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'resourcedescriptor';
DELETE FROM resourcedescriptor_aud WHERE id < 200250000;
UPDATE resourcedescriptor_synonyms_aud t SET resourcedescriptor_id = a.id FROM auditedobject a WHERE t.resourcedescriptor_id = a.old_id AND a.tablename = 'resourcedescriptor';
UPDATE resourcedescriptorpage_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'resourcedescriptorpage';
UPDATE resourcedescriptorpage_aud t SET resourcedescriptor_id = a.id FROM auditedobject a WHERE t.resourcedescriptor_id = a.old_id AND a.tablename = 'resourcedescriptor';
UPDATE roterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM roterm_aud WHERE id IS NULL;
UPDATE rsterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM rsterm_aud WHERE id IS NULL;
UPDATE secondaryidslotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM secondaryidslotannotation_aud WHERE id < 200250000;
UPDATE singlereferenceassociation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'association';
DELETE FROM singlereferenceassociation_aud WHERE id < 200250000;
UPDATE singlereferenceassociation_aud t SET singlereference_id = a.id FROM auditedobject a WHERE t.singlereference_curie = a.old_curie AND a.tablename = 'informationcontententity';
UPDATE slotannotation_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'slotannotation';
DELETE FROM slotannotation_aud WHERE id < 200250000;
UPDATE slotannotation_informationcontententity_aud t SET slotannotation_id = a.id FROM auditedobject a WHERE t.slotannotation_id = a.old_id AND a.tablename = 'slotannotation';
UPDATE slotannotation_informationcontententity_aud t SET evidence_id = a.id FROM auditedobject a WHERE t.evidence_curie = a.old_curie AND a.tablename = 'informationcontententity';
UPDATE soterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM soterm_aud WHERE id IS NULL;
UPDATE species_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'species';
DELETE FROM species_aud WHERE id < 200250000;
UPDATE species_aud t SET taxon_id = a.id FROM auditedobject a WHERE t.taxon_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE species_commonnames_aud t SET species_id = a.id FROM auditedobject a WHERE t.species_id = a.old_id AND a.tablename = 'species';
UPDATE stageterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM stageterm_aud WHERE id IS NULL;
UPDATE synonym_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'synonym';
DELETE FROM synonym_aud WHERE id < 200250000;
UPDATE uberonterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM uberonterm_aud WHERE id IS NULL;
UPDATE variant_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM variant_aud WHERE id IS NULL;
UPDATE variant_aud t SET varianttype_id = a.id FROM auditedobject a WHERE t.varianttype_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE variant_aud t SET sourcegeneralconsequence_id = a.id FROM auditedobject a WHERE t.sourcegeneralconsequence_curie = a.old_curie AND a.tablename = 'ontologyterm';
UPDATE variant_aud t SET variantstatus_id = a.id FROM auditedobject a WHERE t.variantstatus_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE variant_note_aud t SET variant_id = a.id FROM auditedobject a WHERE t.variant_curie = a.old_curie AND a.tablename = 'biologicalentity';
DELETE FROM variant_note_aud WHERE variant_id IS NULL;
UPDATE variant_note_aud t SET relatednotes_id = a.id FROM auditedobject a WHERE t.relatednotes_id = a.old_id AND a.tablename = 'note';
UPDATE vocabulary_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'vocabulary';
DELETE FROM vocabulary_aud WHERE id < 200250000;
UPDATE vocabularyterm_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'vocabularyterm';
DELETE FROM vocabularyterm_aud WHERE id < 200250000;
UPDATE vocabularyterm_aud t SET vocabulary_id = a.id FROM auditedobject a WHERE t.vocabulary_id = a.old_id AND a.tablename = 'vocabulary';
UPDATE vocabularyterm_synonyms_aud t SET vocabularyterm_id = a.id FROM auditedobject a WHERE t.vocabularyterm_id = a.old_id AND a.tablename = 'vocabularyterm';
UPDATE vocabularytermset_aud t SET id = a.id FROM auditedobject a WHERE t.id = a.old_id AND a.tablename = 'vocabularytermset';
DELETE FROM vocabularytermset_aud WHERE id < 200250000;
UPDATE vocabularytermset_aud t SET vocabularytermsetvocabulary_id = a.id FROM auditedobject a WHERE t.vocabularytermsetvocabulary_id = a.old_id AND a.tablename = 'vocabulary';
UPDATE vocabularytermset_vocabularyterm_aud t SET vocabularytermsets_id = a.id FROM auditedobject a WHERE t.vocabularytermsets_id = a.old_id AND a.tablename = 'vocabularytermset';
UPDATE vocabularytermset_vocabularyterm_aud t SET memberterms_id = a.id FROM auditedobject a WHERE t.memberterms_id = a.old_id AND a.tablename = 'vocabularyterm';;
UPDATE vtterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM vtterm_aud WHERE id IS NULL;
UPDATE wbbtterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM wbbtterm_aud WHERE id IS NULL;
UPDATE wblsterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM wblsterm_aud WHERE id IS NULL;
UPDATE wbphenotypeterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM wbphenotypeterm_aud WHERE id IS NULL;
UPDATE xbaterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM xbaterm_aud WHERE id IS NULL;
UPDATE xbedterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM xbedterm_aud WHERE id IS NULL;
UPDATE xbsterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM xbsterm_aud WHERE id IS NULL;
UPDATE xcoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM xcoterm_aud WHERE id IS NULL;
UPDATE xpoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM xpoterm_aud WHERE id IS NULL;
UPDATE xsmoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM xsmoterm_aud WHERE id IS NULL;
UPDATE zecoterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM zecoterm_aud WHERE id IS NULL;
UPDATE zfaterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM zfaterm_aud WHERE id IS NULL;
UPDATE zfsterm_aud t SET id = a.id FROM auditedobject a WHERE t.curie = a.old_curie AND a.tablename = 'ontologyterm';
DELETE FROM zfsterm_aud WHERE id IS NULL;
...
ALTER TABLE biologicalentity_aud DROP COLUMN dataprovider_id;
...
ALTER TABLE reagent_aud DROP COLUMN curie;
ALTER TABLE reagent_aud DROP COLUMN modentityid;
ALTER TABLE reagent_aud DROP COLUMN modinternalid;
ALTER TABLE reagent_aud DROP COLUMN dataprovider_id;
...
INSERT INTO curieobject_aud (id, rev) SELECT id, rev FROM submittedobject_aud;
INSERT INTO curieobject_aud (id, rev) SELECT id, rev FROM ontologyterm_aud;
INSERT INTO curieobject_aud (id, rev) SELECT id, rev FROM informationcontententity_aud;


INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM association_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM biologicalentity_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM bulkload_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM bulkloadfile_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM bulkloadfileexception_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM bulkloadfilehistory_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM bulkloadgroup_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM conditionrelation_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM crossreference_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM dataprovider_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM experimentalcondition_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM genetogeneorthology_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM informationcontententity_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM note_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM ontologyterm_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM organization_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM person_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM personsetting_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM reagent_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM resourcedescriptor_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM resourcedescriptorpage_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM slotannotation_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM species_aud;
INSERT INTO auditedobject_aud (id, rev, revtype) SELECT id, rev, revtype FROM synonym_aud;
