...
@JsonView({ View.FieldsOnly.class, View.ForPublic.class, View.GeneToGeneOrthologyForIndexer.class, View.GOSearchResultDocument.class, View.GeneSearchResultDocument.class })
