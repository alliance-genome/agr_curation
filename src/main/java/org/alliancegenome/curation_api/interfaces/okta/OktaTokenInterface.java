...
public interface OktaTokenInterface {
	...
	@POST
	@Path("/token")
	OktaToken getClientCredentialsAccessToken(@HeaderParam("Authorization") String authorization, @FormParam("grant_type") String grantType, @FormParam("scope") String scope);
}
