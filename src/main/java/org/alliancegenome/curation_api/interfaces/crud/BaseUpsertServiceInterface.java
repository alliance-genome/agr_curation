...
public interface BaseUpsertServiceInterface<E extends AuditedObject, T extends BaseDTO> {
	...
	default E upsert(T dto) throws ValidationException, ObjectWarningException {
		return upsert(dto, null);
	}

	E upsert(T dto, BackendBulkDataProvider dataProvider) throws ValidationException, ObjectWarningException;
