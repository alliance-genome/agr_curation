...
@Path("/genemolecularinteraction/document")
@Tag(name = "Public Document Endpoints")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public interface GeneMolecularInteractionDocumentInterface {
	...
	SearchResponse<GeneMolecularInteraction> findByIds(@RequestBody List<Long> ids);
