...
public final class VocabularyConstants {
	...
	public static final String PARALOGY_CONFIDENCE_VOCABULARY = "paralogy_confidence";
	public static final String PARALOGY_PREDICTION_METHOD_VOCABULARY = "paralogy_prediction_method";
