...
public final class VocabularyConstants {
	...
	public static final String ANTIBODY_HOST_TAXON_VOCABULARY_TERM_SET = "antibody_host_taxon";
	public static final String ANTIBODY_ANTIGEN_TAXON_VOCABULARY_TERM_SET = "antibody_antigen_taxon";
