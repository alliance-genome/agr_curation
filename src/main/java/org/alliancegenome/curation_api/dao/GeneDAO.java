...
public class GeneDAO extends BaseSQLDAO<Gene> {
	...
	public void deleteReferencingDiseaseAnnotations(List<String> geneCuries) {
		getBatches(geneCuries, 10000)
			.forEach(this::deleteReferencingDiseaseAnnotationsSmallBatches);
	}

	protected <T> List<List<T>> getBatches(List<T> collection, int batchSize) {
	...
	public void deleteReferencingDiseaseAnnotationsSmallBatches(List<String> geneCuries) {
