...
@RequestScoped
public class BulkLoadGroupCrudController extends BaseCrudController<BulkLoadGroupService, BulkLoadGroup, BulkLoadGroupDAO> implements BulkLoadGroupCrudInterface {
