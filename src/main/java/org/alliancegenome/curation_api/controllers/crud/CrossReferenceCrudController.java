...
@RequestScoped
public class CrossReferenceCrudController extends BaseController<CrossReferenceService, CrossReference, CrossReferenceDAO> implements CrossReferenceCrudInterface {
