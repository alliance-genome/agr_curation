...
public class AnalysisConfigurer implements ElasticsearchAnalysisConfigurer {
	...
	public void configure(ElasticsearchAnalysisConfigurationContext context) {
		...
		context.tokenizer("ngram_tokenizer").type("ngram").param("min_gram", 1).param("max_gram", 29).param("token_chars", "punctuation", "letter", "digit");

		context.tokenizer("search_query_tokenizer").type("whitespace");

		context.tokenFilter("ngram_filter").type("ngram").param("min_gram", 1).param("max_gram", 29);
