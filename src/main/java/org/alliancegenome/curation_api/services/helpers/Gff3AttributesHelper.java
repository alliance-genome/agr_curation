...
public class Gff3AttributesHelper {
	 ...
	 * ({@code species.getDisplayName() + ":"}, e.g. {@code ZFIN:}), or null if there is none.
	 *
	 ...
	 */
	public static String getModCurieFromDbxref(Map<String, String> attributes, Species species) {
