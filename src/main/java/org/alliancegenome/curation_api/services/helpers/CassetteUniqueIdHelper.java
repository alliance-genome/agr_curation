...
/**
 * SCRUM-6535: mirrors ConstructUniqueIdHelper.
 *
 * Component ids are sorted before being folded in so that the same cassette submitted with its
 * components in a different order still yields the same unique id.
 */
