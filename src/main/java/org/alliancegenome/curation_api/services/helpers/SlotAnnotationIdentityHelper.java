...
public class SlotAnnotationIdentityHelper {
	...
	/**
	 * SCRUM-6535. Identical in shape to constructComponentIdentity; the two stay separate because the
	 * annotation types are unrelated even though their fields line up.
	 */
