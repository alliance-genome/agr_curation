...
public enum ChromosomeAccessionEnum {
	...
	// RGD GRCr8 (NCBI GCF_036323735.1). Chromosomes 1-20, X, Y have new RefSeq accessions;
	// GRCr8 does not bundle a mitochondrial sequence, so MT (NC_001665.2) is reused from
	// mRatBN7.2. NOTE: getChromosomeAccessionEnum() keys on accession only, so the reused
	// MT accession resolves to mRatBN7.2 first.
	...
	RGD_GRCr8_MT("MT", "RefSeq:NC_001665.2", "GRCr8"),
