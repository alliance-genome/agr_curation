...
public enum BackendBulkLoadType {
	...
	CONSTRUCT_CASSETTE_ASSOCIATION("json"),
	CASSETTE_GENOMIC_ENTITY_ASSOCIATION("json"),
	CASSETTE_TRANSGENIC_TOOL_ASSOCIATION("json"),
	CASSETTE_STR_ASSOCIATION("json"),
