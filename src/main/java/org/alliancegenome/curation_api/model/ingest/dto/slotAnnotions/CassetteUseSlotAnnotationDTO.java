...
/** SCRUM-6535: ingest form of the use(s) of a cassette - FBcv 'experimental_tool_descriptor' terms. */
@Data
@EqualsAndHashCode(callSuper = true)
@AGRCurationSchemaVersion(min = "2.18.0", max = LinkMLSchemaConstants.LATEST_RELEASE, dependencies = { SlotAnnotationDTO.class })
public class CassetteUseSlotAnnotationDTO extends SlotAnnotationDTO {
