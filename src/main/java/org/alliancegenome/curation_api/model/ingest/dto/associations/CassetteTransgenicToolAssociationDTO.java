...
/** SCRUM-6535: ingest form of the association between a cassette and a transgenic tool component. */
@Data
...
public class CassetteTransgenicToolAssociationDTO extends EvidenceAssociationDTO {
	...
	@JsonView({ CurationView.FieldsOnly.class })
	@JsonProperty("transgenic_tool_identifier")
	private String transgenicToolIdentifier;
