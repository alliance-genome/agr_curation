...
/** SCRUM-6535: ingest form of the association between a cassette and a genomic entity component. */
@Data
...
public class CassetteGenomicEntityAssociationDTO extends EvidenceAssociationDTO {
	...
	@JsonProperty("component_type_curies")
	private List<String> componentTypeCuries;
