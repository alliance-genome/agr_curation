...
public class CassetteComponentSlotAnnotation extends SlotAnnotation {
	...
	@JoinTable(
			...
			indexes = {
					@Index(name = "slotannotation_note_ccsa_cst_index", columnList = "slotannotation_id"),
					@Index(name = "slotannotation_note_relatednotes_cst_index", columnList = "relatednotes_id")
			}
	)
