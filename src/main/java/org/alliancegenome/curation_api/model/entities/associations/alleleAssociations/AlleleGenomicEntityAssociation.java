...
import org.alliancegenome.curation_api.model.entities.SingleReferenceAssociation;
...
@JsonSubTypes({ @JsonSubTypes.Type(value = AlleleGeneAssociation.class, name = "AlleleGeneAssociation") })
@Audited
@Entity
@Data
