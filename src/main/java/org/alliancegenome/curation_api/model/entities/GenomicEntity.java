...
public class GenomicEntity extends BiologicalEntity {
	...
	@JsonView({View.FieldsAndLists.class, View.AlleleView.class, View.GeneView.class, View.AffectedGenomicModelView.class, View.VariantView.class, View.GeneSummaryDocument.class, View.AlleleSummaryDocument.class })
