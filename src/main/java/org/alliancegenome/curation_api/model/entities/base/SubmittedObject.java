...
public class SubmittedObject extends CurieObject {
	...
	@JsonView({ View.FieldsAndLists.class, View.AlleleView.class, View.GeneView.class, View.AffectedGenomicModelView.class, View.ConstructView.class, View.VariantView.class })
	@JoinTable(
