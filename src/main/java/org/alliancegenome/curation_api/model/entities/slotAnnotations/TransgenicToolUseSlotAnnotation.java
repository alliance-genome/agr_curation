...
@Schema(name = "TransgenicToolUseSlotAnnotation", description = "TransgenicToolUseSlotAnnotation: a transgenic tool use slot annotation")
public class TransgenicToolUseSlotAnnotation extends SlotAnnotation {
	...
	@JoinTable(
			...
			indexes = {
					@Index(name = "slotannotation_note_ttusa_index", columnList = "slotannotation_id"),
					@Index(name = "slotannotation_note_relatednotes_ttusa_index", columnList = "relatednotes_id")
			}
	)
