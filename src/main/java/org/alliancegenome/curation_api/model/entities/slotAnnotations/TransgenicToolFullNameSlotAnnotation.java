...
@Schema(name = "TransgenicToolFullNameSlotAnnotation", description = "TransgenicToolFullNameSlotAnnotation: the one current full name for the transgenic tool")
public class TransgenicToolFullNameSlotAnnotation extends NameSlotAnnotation {
