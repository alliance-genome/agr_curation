...
/** SCRUM-6535: the one current symbol for the cassette. */
@Entity
@Data
...
@Schema(name = "CassetteSymbolSlotAnnotation", description = "CassetteSymbolSlotAnnotation: the one current symbol for the cassette")
public class CassetteSymbolSlotAnnotation extends NameSlotAnnotation {
