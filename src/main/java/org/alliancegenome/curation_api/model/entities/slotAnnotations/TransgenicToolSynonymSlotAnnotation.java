...
@Schema(name = "TransgenicToolSynonymSlotAnnotation", description = "TransgenicToolSynonymSlotAnnotation: all aliases (non-preferred names) for the transgenic tool")
