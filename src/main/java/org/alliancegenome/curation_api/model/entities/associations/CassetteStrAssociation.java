...
/** SCRUM-6535: a sequence targeting reagent that is a component of the cassette. */
@Entity
@Data
...
public class CassetteStrAssociation extends CassetteAssociation {
	...
	@JsonIgnoreProperties({"cassetteStrAssociations", "sequenceTargetingReagentGeneAssociations"})
	private SequenceTargetingReagent cassetteStrAssociationObject;
	...
	@JoinTable(
		...
		indexes = {
			@Index(name = "cassettestrassoc_note_assoc_index", columnList = "cassettestrassociation_id"),
			@Index(name = "cassettestrassoc_note_relatednotes_index", columnList = "relatednotes_id")
		}
	)
