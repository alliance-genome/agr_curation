...
@Schema(name = "TransgenicToolSymbolSlotAnnotation", description = "TransgenicToolSymbolSlotAnnotation: the one current symbol for the transgenic tool")
public class TransgenicToolSymbolSlotAnnotation extends NameSlotAnnotation {
