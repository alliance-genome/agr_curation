...
@Table(indexes = {
	@Index(name = "transcriptexonassociation_subject_index", columnList = "transcriptassociationsubject_id"),
	@Index(name = "transcriptexonassociation_relation_index", columnList = "relation_id"),
	@Index(name = "transcriptexonassociation_object_index", columnList = "transcriptexonassociationobject_id")
})
