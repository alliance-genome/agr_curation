...
All requests matching this path will be proxies, no org.alliancegenome.curation_api.exceptions. This includes requests for `text/html`, which the standard `proxy` option does not proxy.
