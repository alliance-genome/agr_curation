...
export class DataLoadService extends BaseAuthService {
		...
		getBackendBulkLoadTypes(loadType) {
				const bulkLoadTypes = {
						...
						BulkManualLoad: ["FULL_INGEST", "DISEASE_ANNOTATION", "GENE_DISEASE_ANNOTATION", "ALLELE_DISEASE_ANNOTATION", "AGM_DISEASE_ANNOTATION", "GENE", "ALLELE", "AGM", "CONSTRUCT", "ALLELE_ASSOCIATION" ]
				};
