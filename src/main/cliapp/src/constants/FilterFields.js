export const FIELD_SETS = Object.freeze({
	...
	diseaseAnnotationSubjectFieldSet: {
		...
		fields: [
			...
			'diseaseAnnotationSubject.alleleFullName.formatText',
			'diseaseAnnotationSubject.alleleFullName.displayText',
			'diseaseAnnotationSubject.alleleSymbol.formatText',
			'diseaseAnnotationSubject.alleleSymbol.displayText',
			'diseaseAnnotationSubject.alleleSynonyms.formatText',
			'diseaseAnnotationSubject.alleleSynonyms.displayText',
			'diseaseAnnotationSubject.alleleSecondaryIds.secondaryId',
			'diseaseAnnotationSubject.geneFullName.formatText',
			'diseaseAnnotationSubject.geneFullName.displayText',
			'diseaseAnnotationSubject.geneSymbol.formatText',
			'diseaseAnnotationSubject.geneSymbol.displayText',
			'diseaseAnnotationSubject.geneSynonyms.formatText',
			'diseaseAnnotationSubject.geneSynonyms.displayText',
			'diseaseAnnotationSubject.geneSystematicName.formatText',
			'diseaseAnnotationSubject.geneSystematicName.displayText',
			'diseaseAnnotationSubject.geneSecondaryIds.secondaryId',
		],
	},
