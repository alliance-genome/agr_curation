...
describe('TruncatedReferencesTemplate', () => {
	it('should render a list of references when references prop is not null and has length greater than 0', () => {
		...
		const reference1 = result.getByText(
			'PMID:000001 (FB:FBgn0000001|MGI:MGI:0000001|RGD:2000001|SGD:S000001|WB:WBGene00000001|ZFIN:ZDB-GENE-000000-1|ExtraCurie:111|MainCurie:111)'
		);
		const reference2 = result.getByText(
			'PMID:000002 (FB:FBgn0000002|MGI:MGI:0000002|RGD:2000002|SGD:S000002|WB:WBGene00000002|ZFIN:ZDB-GENE-000000-2|ExtraCurie:222|MainCurie:222)'
		);
	...
	it('should render a truncated list of references when references prop has length greater than 5', () => {
		const references = [
			{
				curie: 'MainCurie:111',
				crossReferences: [{ referencedCurie: 'PMID:000001' }, { referencedCurie: 'FB:FBgn0000001' }],
			},
			{
				curie: 'MainCurie:222',
				crossReferences: [{ referencedCurie: 'PMID:000002' }, { referencedCurie: 'MGI:MGI:0000002' }],
			},
			{
				curie: 'MainCurie:333',
				crossReferences: [{ referencedCurie: 'PMID:000003' }, { referencedCurie: 'RGD:2000003' }],
			},
			{
				curie: 'MainCurie:444',
				crossReferences: [{ referencedCurie: 'PMID:000004' }, { referencedCurie: 'SGD:S000004' }],
			},
			{
				curie: 'MainCurie:555',
				crossReferences: [{ referencedCurie: 'PMID:000005' }, { referencedCurie: 'WB:WBGene00000005' }],
			},
			{
				curie: 'MainCurie:666',
				crossReferences: [{ referencedCurie: 'PMID:000006' }, { referencedCurie: 'ZFIN:ZDB-GENE-000000-6' }],
			},
		];
