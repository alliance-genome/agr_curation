...
describe('NestedListDialogTemplate', () => {
	it('should return null when the entities prop is falsy', () => {
		...
		const { container } = render(
			<NestedListDialogTemplate entities={entities} handleOpen={handleOpen} getTextField={getTextField} />
		);
	...
	it('should return null when the getTextField prop is falsy', () => {
		...
		const { container } = render(<NestedListDialogTemplate entities={entities} handleOpen={handleOpen} />);
	...
	it('should render a list of strings from subtype array', () => {
		...
		const handleOpen = vi.fn();
		const subType = 'subType';
		const getTextString = vi.fn((item) => item.name);
