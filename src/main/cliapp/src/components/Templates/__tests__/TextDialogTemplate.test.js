...
describe('TextDialogTemplate', () => {
  ...
  it('should return null when entity is falsy', () => {
    ...
    const { container } = render(<TextDialogTemplate entity={entity} handleOpen={handleOpen} text={entity?.displayText} />);
  ...
  it('should accept any entity type', () => {
    ...
    const result2 = render(<TextDialogTemplate entity={entity2} handleOpen={handleOpen} text={entity2?.subEntity?.name} />);
    const result3 = render(<TextDialogTemplate entity={entity3} handleOpen={handleOpen} text={entity3?.subEntity?.subSubEntity?.display} />);
  ...
  it('should render <sup> tags in the HTML', async () => {
    ...
    const { container } = render(<TextDialogTemplate entity={entity} handleOpen={handleOpen} text={entity?.subEntity?.displayText} />);
