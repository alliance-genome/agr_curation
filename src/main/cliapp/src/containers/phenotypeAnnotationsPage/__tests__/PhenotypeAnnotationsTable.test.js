...
describe("<PhenotypeAnnotationsPage />", () => {
	...
	it("The table contains correct data", async () => {
		...
		const uniqueIdTd = await result.findByText("ZFIN:ZDB-FISH-150901-427|has_phenotype|head decreased size, abnormal|PATO:0000587|ZFA:0001114|AGRKB:101000000388372|has_condition|ZECO:0000103|standard conditions");
