...
export const ReportHistoryTable = ({ history }) => {
	const pdfBody = (rowData) => (
		<a href={rowData.pdfUrl} rel="noopener noreferrer" target="_blank">
			PDF
		</a>
	);
	const xlsBody = (rowData) => (
		<a href={rowData.xlsUrl} rel="noopener noreferrer" target="_blank">
			XLS
		</a>
	);
	const htmlBody = (rowData) => (
		<a href={rowData.htmlUrl} rel="noopener noreferrer" target="_blank">
			HTML
		</a>
	);
