	...
	const reportActionBodyTemplate = (rowData) => {
		...
		buttons.push(
			<Button
				...
				onClick={() => handleReportOpen(rowData)}
			/>
		);
		buttons.push(
			<Button
				...
				onClick={() => handleReportEdit(rowData)}
			/>
		);
