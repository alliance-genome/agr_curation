...
export const MutationTypesForm = ({ state, dispatch }) => {
	...
	const mutationTypes = structuredClone(state.allele?.[entityType]);
	...
	return (
		<FormTableWrapper
			...
			button={
				<Button label="Add Mutation Type" onClick={createNewMutationTypeHandler} className="w-4  p-button-text" />
			}
		/>
	);
};
