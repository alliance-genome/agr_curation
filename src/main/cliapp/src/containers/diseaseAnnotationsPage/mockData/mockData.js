	...
	results: [
		{
			...
			diseaseGeneticModifierAgms: [{ name: 'DGM AGM test', modEntityId: 'WB:DGM1' }],
			diseaseGeneticModifierAlleles: [{ modEntityId: 'WB:DGM2', alleleSymbol: { displayText: 'DGM Allele test' }}],
			diseaseGeneticModifierGenes: [{ modEntityId: 'WB:DGM3', geneSymbol: { displayText: 'DGM Gene test' }}],
