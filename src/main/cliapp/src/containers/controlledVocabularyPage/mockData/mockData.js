export const data = {
	results: [
		{
			dateCreated: '2022-01-25T15:12:15.524085Z',
			dateUpdated: '2022-01-25T15:12:15.524087Z',
			internal: false,
			obsolete: false,
			id: 6363427,
			name: 'ECO:0007014',
			...
			vocabulary: {
				...
				vocabularyDescription:
					'Evidence codes (ECO terms) with letter code abbreviations used in AGR disease annotations',
			},
		},
	],
	totalResults: 1,
